...
raw_vcf=/home/zwc1988/Data/Betta/3.Splendens_complex/SNPcalling/Splendens_complex615_all.hardfilter.vcf.gz
...
# $vcftools --gzvcf $raw_vcf --maf 0.02 --min-alleles 2 --max-alleles 2 --max-missing 0.5 --minQ 30 --recode --recode-INFO-all --stdout | $bgzip -c > Splendens_615ind_maf0.02miss0.5minQ30allele2.vcf.gz
####################switch chrName#################
# switch_chrName=/home/zwc1988/Data/Betta/3.Splendens_complex/SNPcalling/switch_chrName.txt
# old_vcf=/home/zwc1988/Data/Betta/3.Splendens_complex/SNPcalling/Splendens_615ind_maf0.02miss0.5minQ30allele2.vcf.gz
# bcftools annotate \
#   --rename-chrs ${switch_chrName} ${old_vcf} | \
#   bgzip -c > Splendens_615ind_maf0.02miss0.5minQ30allele2.numberChr.vcf.gz
####################filter,only contain PASS#################
gzvcf=/home/zwc1988/Data/Betta/3.Splendens_complex/SNPcalling/Splendens_615ind_maf0.02miss0.5minQ30allele2.numberChr.vcf.gz
$vcftools --gzvcf ${gzvcf} \
    --remove-filtered-all --recode --recode-INFO-all \
    --stdout | \
    $bgzip -c > Splendens_615ind_maf0.02miss0.5minQ30allele2.numberChr.pass.vcf.gz
